...
export class BackendService {
  ...
  // imgPath: string = 'http://localhost:8080/backendSRBS/images/';
  basePath: string = 'https://smartsoln.org/backendSRBS/scripts/';
  imgPath: string = 'https://smartsoln.org/backendSRBS/images/';
  // basePath: string = 'http://52.63.82.10/backendSRBS/scripts/';
  // imgPath: string = 'http://52.63.82.10/backendSRBS/images/';
  // basePath = 'assets/backendSRBS/scripts/';
  // basePath = 'assets/backendSRBS/images/';
  weather_api: string =
